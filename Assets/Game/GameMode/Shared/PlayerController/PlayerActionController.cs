...
//     version 1.11.1
//     from Assets/Game/GameMode/Shared/PlayerController/PlayerActionController.inputactions
//
...
public partial class @PlayerActionController: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""SpaceBar"",
                    ""type"": ""Button"",
                    ""id"": ""fa342c5b-8027-48fb-acc1-0e0967849022"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""7dcda3ef-b1a5-42b7-b38a-9099f14335d1"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard/Mouse"",
    ...
    ""controlSchemes"": [
        ...
        m_InputActionPlayer_SpaceBar = m_InputActionPlayer.FindAction("SpaceBar", throwIfNotFound: true);
        m_InputActionPlayer_MousePosition = m_InputActionPlayer.FindAction("MousePosition", throwIfNotFound: true);
    }

    ~@PlayerActionController()
    {
        UnityEngine.Debug.Assert(!m_InputActionPlayer.enabled, "This will cause a leak and performance issues, PlayerActionController.InputActionPlayer.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_InputActionPlayer_SpaceBar;
    ...
    public struct InputActionPlayerActions
    {
        ...
        public InputAction @SpaceBar => m_Wrapper.m_InputActionPlayer_SpaceBar;
